%# This script is to find sub-consecutive sequences within a longer sequence.
...
%      5     7    10     4
%      
% It tells you that there are two sequences of repeated 5. 
% The first starts at position 1 and ends in pos 2 and it's length is 2. 
% Same interpretation for the other sequence.
